...
- For CUDA: CUDA Toolkit 12.0 or newer (12.9 is what `.devops/cuda.Dockerfile` pins
  and what CI images use), and a host GCC the toolkit accepts — CUDA 12.9 supports
  up to GCC 14
